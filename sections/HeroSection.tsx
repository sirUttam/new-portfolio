  ...
  return (
    <section id="hero" className="relative min-h-screen scroll-mt-24 pt-20">
      <div className="container grid gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        >
          <p className="mb-4 text-sm uppercase tracking-[0.3em] text-muted">Backend Developer | Data Analyst | Machine Learning</p>
          <h1 className="text-4xl font-semibold leading-tight text-text sm:text-5xl">
            Hi, I'm Uttam Aryal.
          </h1>
          <p className="mt-6 max-w-xl text-base leading-8 text-muted sm:text-lg">
            Building backend applications with FastAPI, PostgreSQL & Docker. Exploring data analysis, machine learning, and model deployment. Always learning something new.
          </p>
        </motion.div>
        ...
        >
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2.5rem] border border-[rgba(201,162,39,0.33)] bg-[#111820] p-5 shadow-soft"
          >
            <div className="absolute inset-0 rounded-[2.5rem] bg-[radial-gradient(circle_at_top,_rgba(201,162,39,0.1),transparent_45%)]" />
            <div className="relative overflow-hidden rounded-[2rem] border border-[rgba(255,255,255,0.1)] bg-[#0f1724] p-6">
              <Image
                src="/profile.png"
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            {techCloud.map((item) => (
              <motion.span
                ...
                animate={{
                  opacity: [0.72, 1, 0.72],
                  boxShadow: ['0 0 0 rgba(201,162,39,0)', '0 0 0 1px rgba(201, 163, 39, 0.62)', '0 0 0 rgba(201,162,39,0)']
                }}
